...
class TilemapGame {
    ...
    constructor(param) {
        ...
        // this.testId = param.testId || "test";
        // this.dataSaver = param.dataSaver;

        // this.playerId = localStorage.getItem("playerData") || "no id";
        // this.playerData = this.testId + " _ ";
        ...
        this.autoTimer = param.autoTimer ?? false;
        ...
        this.btnExit.addEventListener("touchstart", () => {
            ...
            if (this.currentLevel != 1) {
                this.submitForm();
                // this.saveData(this.playerId, this.playerData);
            }
    ...
    //         try {
    //             const response = await fetch(this.dataSaver, {
    //                 method: "POST",
    //                 headers: {
    ...
    loadLevel() {
        ...
        this.textTime.textContent = "00:00";
    ...
    drawCommandPanel(mode, length) {
            ...
            for (let i=0; i < length; i++) {
                ...
                panel.addEventListener("touchstart", (event) => {
                    if (!this.isRunning && !this.isGameOver) {
                        ...
                        // First Touch Timer
                        if (!this.autoTimer && !this.firstCommand) {
                            this.startTime = Date.now();
                            this.timerInterval = setInterval(() => this.timerCount(), 100);
        ...
        //============================================================================ Scroll Mode
            ...
            for (let i=0; i < length; i++) {
                ...
                // panel.style.opacity = transparentValue;
                this.commandPanel.append(panel);
                ...
                const endHandler = (event) => {
                    ...
                    dropper.forEach((e, id) => {
                        ...
                        if (Math.abs(draggerRect.left - dropperRect.left) < 30 && Math.abs(draggerRect.top - dropperRect.top) < 30) {
                            ...
                            if (i == 0){
                                dropper[id].className = "drag";
                            }
                            else {
                                dropper[id].className = "drag filled";
                            }
